...
Sample Code included in repo from First Blockchain in Java and Tiniest Blockchain in Python tutorials. For more projects and free APIs, check out: [Build Your Own X](https://github.com/codecrafters-io/build-your-own-x) and [Public APIs repo](https://github.com/public-apis/public-apis). 💚
